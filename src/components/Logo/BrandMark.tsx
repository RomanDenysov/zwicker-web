...
type Props = {
  /** Pixel size; omit to let CSS size the SVG (e.g. via `em` in the hero). */
  size?: number
...
/** The circular ©-monogram brand mark. Inherits color via `currentColor`. */
export const BrandMark = ({ size, title, className }: Props) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 50 50"
