...
const themeColor = 'var(--theme-elevation-1000)'

/**
 * Admin-panel login logo: the circular Zwicker ©-monogram with wordmark + tagline.
 * Uses the admin theme's contrast color so it adapts to light and dark mode.
 */
export const Logo = () => (
  <div
    style={{
